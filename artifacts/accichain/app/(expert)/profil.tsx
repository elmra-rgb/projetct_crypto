    ...
    <View style={styles.root}>
      ...
      >
        ...
        <GlassCard style={styles.menuCard} padding={0} radius={24}>
          ...
          <MenuItem icon="award" label="Certification expertise" value="Niveau III · Agree DGSN" />
          <MenuItem icon="map-pin" label="Zone d'intervention" value="Casablanca · Rabat · Fes" />
        </GlassCard>
