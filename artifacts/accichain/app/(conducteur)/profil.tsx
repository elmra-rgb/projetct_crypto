  ...
  return (
    <View style={styles.infoRow}>
      ...
      <Pressable onPress={handleCopy} style={[styles.copyBtn, copied && styles.copyBtnDone]}>
        <Feather name={copied ? "check" : "copy"} size={13} color={copied ? "#10c97b" : "#1c6ea9"} />
    ...
    <View style={styles.root}>
      ...
      >
        ...
        <View style={styles.statsRow}>
          ...
          <GlassCard padding={16} style={styles.statCard} radius={22}>
            <Text
              style={[styles.statNumber, { fontSize: totalMontant > 0 ? 14 : 22 }]}
              numberOfLines={1}
            >
        ...
        <GlassCard style={styles.menuCard} padding={0} radius={24}>
          ...
          <MenuItem icon="shield" label="Niveau de sécurité" value="Élevé · Signature ECDSA (MetaMask)" />
        </GlassCard>
          ...
          <GlassCard style={styles.modal} padding={24} radius={28}>
            ...
            <View style={styles.modalHeader}>
              <View style={styles.modalIconBox}>
                <MaterialCommunityIcons name="ethereum" size={26} color="#1c6ea9" />
              </View>
...
const styles = StyleSheet.create({
  ...
  roleBadge: {
    ...
    backgroundColor: "rgba(44,124,182,0.1)", paddingVertical: 4,
    paddingHorizontal: 12, borderRadius: 30,
  },
  ...
  modalIconBox: {
    ...
    backgroundColor: "rgba(28,110,169,0.1)",
    alignItems: "center", justifyContent: "center",
  },
  ...
  infoRow: {
    flexDirection: "row", alignItems: "center",
    backgroundColor: "rgba(28,110,169,0.05)", borderRadius: 14,
    padding: 12, gap: 10,
  },
  ...
  copyBtn: {
    ...
    backgroundColor: "rgba(28,110,169,0.1)", paddingHorizontal: 10,
    paddingVertical: 6, borderRadius: 10,
  },
  copyBtnDone: { backgroundColor: "rgba(16,201,123,0.1)" },
  copyText: { fontSize: 11, fontFamily: "Inter_600SemiBold", color: "#1c6ea9" },
  ...
  closeBtn: {
    backgroundColor: "rgba(28,110,169,0.1)", borderRadius: 16,
    paddingVertical: 14, alignItems: "center", marginTop: 8,
  },
  closeBtnText: { fontSize: 15, fontFamily: "Inter_600SemiBold", color: "#1c6ea9" },
});
